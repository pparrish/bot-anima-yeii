export default [
  ...
  'Cansancio',
  'Necesidades físicas',
  'Modificadores a la habilidad',
  'Armas comunes',
  'Armas exóticas de diseño',
  'Armas improvisadas',
  'Escudos',
  ...
  'Rituales mágicos',
  'Modificadores a la detección mágica',
  'Análisis mágico',
  'Las dificultades de convocación',
  'El tiempo de los rituales',
  'Modificadores de la convocatoria',
  'La rueda',
  'Potencial psíquico base',
  'La concentración',
  ...
  'Intensidades de frío',
  'Intensidades de electricidad',
  'Presencias',
  'Barrera de daño y daño estructural',
  'La experiencia en combate',
  'Elan',
  'Características en seres mágicos',
  'La creación de seres',
  'Rotura y endereza en armas naturales',
  'Adaptaciones de características',
  'La tabla de combate',
]
